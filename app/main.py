...
def show_appointments():
    ...
    appointments = [
        ...
        {"Time": "10:30 AM", "Patient": "Jane Smith", "Type": "New Patient", "Status": "Confirmed"},
        {"Time": "02:00 PM", "Patient": "Mike Johnson", "Type": "Consultation", "Status": "Pending"},
        {"Time": "03:30 PM", "Patient": "Sarah Wilson", "Type": "Follow-up", "Status": "Confirmed"}
    ]
    ...
    with col2:
        st.selectbox("Patient", ["John Doe", "Jane Smith", "Mike Johnson", "Sarah Wilson"], key="appt_patient")
        st.selectbox("Appointment Type", ["Consultation", "Follow-up", "New Patient", "Emergency"], key="appt_type")
...
def show_prescriptions():
    ...
    prescriptions = [
        {"Patient": "John Doe", "Medication": "Lisinopril", "Dosage": "10mg daily", "Status": "Active"},
        {"Patient": "Jane Smith", "Medication": "Metformin", "Dosage": "500mg twice daily", "Status": "Active"},
        {"Patient": "Mike Johnson", "Medication": "Atorvastatin", "Dosage": "20mg daily", "Status": "Refill Needed"},
        {"Patient": "Sarah Wilson", "Medication": "Omeprazole", "Dosage": "40mg daily", "Status": "Active"}
    ]
    ...
    with st.form("new_prescription"):
        ...
        with col1:
            st.selectbox("Patient", ["John Doe", "Jane Smith", "Mike Johnson", "Sarah Wilson"], key="rx_patient")
